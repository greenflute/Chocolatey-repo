...
$url        = 'https://ide.update.aardio.com/releases/aardio.7z' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'aardio*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
